...
def_EHelper(slt) { rtl_li(s, ddest, (sword_t)*id_src1->preg < (sword_t)*id_src2->preg ? 1 : 0); }
def_EHelper(slti) { rtl_li(s, ddest, (sword_t)*id_src1->preg < (sword_t)id_src2->imm ? 1 : 0); }
